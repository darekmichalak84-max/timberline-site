...
export const metadata = {
  title: "Decking Services in Plymouth",
  description:
    "Timberline provides timber and composite decking installation in Plymouth, Saltash, Ivybridge, Tavistock, and surrounding areas. Get a free quote today.",
};
    ...
    <main className="min-h-screen bg-white text-slate-900">
      <section className="relative isolate overflow-hidden">
        <Image
          ...
          alt="Decking installation in Plymouth by Timberline"
          fill
          priority
          sizes="100vw"
        ...
        <div className="mx-auto flex min-h-[70vh] max-w-7xl items-end px-6 pb-16 pt-32 md:pb-20">
          <div className="max-w-3xl text-white">
            ...
            <h1 className="mt-3 text-4xl font-black leading-tight md:text-6xl">
              Decking Services in Plymouth
            </h1>
            <p className="mt-5 text-lg leading-8 text-slate-200">
              Timber and composite decking installed for homes and gardens across
              Plymouth and nearby areas. Timberline delivers quality workmanship,
              reliable service, and free no-obligation quotes.
            </p>
        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black md:text-4xl">
              Quality decking built to last
            </h2>
            <p className="mt-5 text-lg leading-8 text-slate-600">
              We install timber and composite decking designed to make better use
              of your outdoor space. Whether you want a clean entertaining area,
              a raised deck, or a practical garden feature, Timberline provides
              a tidy, dependable finish built to suit your property.
            </p>
            <p className="mt-5 text-lg leading-8 text-slate-600">
              We work across Plymouth, Saltash, Ivybridge, Tavistock, and
              surrounding areas, offering free quotes and friendly advice on the
              best decking option for your garden.
            </p>
          </div>
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-3xl shadow-xl">
            <Image
              src="/gallery-2.jpg"
              alt="Timberline decking project in Plymouth"
              fill
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-black md:text-4xl">
              Decking services for homes and gardens
            </h2>
          </div>
            ...
            {[
              {
                ...
                text: "New timber and composite decking installed to improve the look, use, and comfort of your garden.",
              },
              {
                title: "Decking Replacement",
                text: "Replacement for old, worn, or damaged decking with a fresh and reliable finish.",
              },
              {
                title: "Tailored Designs",
                text: "Decking layouts and finishes designed to suit your outdoor space and the way you want to use it.",
              },
            ].map((item) => (
              <div
                key={item.title}
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-black md:text-4xl">
            Decking in Plymouth and nearby areas
          </h2>
          <p className="mt-5 text-lg leading-8 text-slate-600">
            Timberline provides decking services across Plymouth, Saltash,
            Ivybridge, Tavistock, and surrounding areas. If you are looking for
            reliable decking specialists in Plymouth, get in touch for a free
            quote.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="rounded-3xl border border-slate-200 p-6">
              <h3 className="text-xl font-bold text-slate-900">
                Do you install decking in Plymouth?
              </h3>
              <p className="mt-3 leading-7 text-slate-600">
                Yes, Timberline provides decking installation and replacement
            ...
            <div className="rounded-3xl border border-slate-200 p-6">
              <h3 className="text-xl font-bold text-slate-900">
                Can I get a free decking quote?
              </h3>
              <p className="mt-3 leading-7 text-slate-600">
            ...
            <div className="rounded-3xl border border-slate-200 p-6">
              <h3 className="text-xl font-bold text-slate-900">
                Do you install timber and composite decking?
              </h3>
              <p className="mt-3 leading-7 text-slate-600">
                Yes, we can install both timber and composite decking depending
      ...
      <section className="bg-amber-700 py-16 text-white">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-amber-100">
            ...
            or composite decking in Plymouth and surrounding areas.
          </p>
